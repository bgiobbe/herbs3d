class AffinitiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @affinity.save
        ...
        format.json { render :show, status: :created, location: @affinity }
      else
  ...
  def update
    respond_to do |format|
      if @affinity.update(affinity_params)
        ...
        format.json { render :show, status: :ok, location: @affinity }
      else
  ...
  def destroy
    @affinity.destroy
    respond_to do |format|
      format.html { redirect_to affinities_url, notice: 'Affinity was successfully destroyed.' }
  ...
  private
    ...
    def affinity_params
      params.require(:affinity).permit(:name, :notes)
    end
end
